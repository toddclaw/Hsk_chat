...
for t in test/validator.test.js test/prompt.test.js test/md.test.js test/time.test.js test/pace.test.js test/senses.test.js test/sync.test.js test/issues.test.js test/release.test.js; do
  printf '\n=== %s ===\n' "$t"
  node "$t"
done
