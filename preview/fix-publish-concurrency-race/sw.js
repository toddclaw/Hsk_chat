...
const SHELL = [
  "./", "./index.html", "./validator.js", "./prompt.js", "./md.js", "./time.js", "./pace.js", "./mistakes.js", "./retrieval.js", "./report.js", "./senses.js", "./sync.js", "./issues.js",
  "./manifest.json", "./data/hsk1.json", "./icon-192.png", "./icon-512.png"
];

const isShell = path => path.endsWith("/") ||
  /\/(index\.html|validator\.js|prompt\.js|md\.js|time\.js|pace\.js|mistakes\.js|retrieval\.js|report\.js|senses\.js|sync\.js|issues\.js|manifest\.json)$/.test(path);
