...
const SHELL = [
  "./", "./index.html", "./validator.js", "./prompt.js", "./pace.js", "./senses.js", "./manifest.json",
  "./data/hsk1.json", "./icon-192.png", "./icon-512.png"
];

const isShell = path => path.endsWith("/") ||
  /\/(index\.html|validator\.js|prompt\.js|pace\.js|senses\.js|manifest\.json)$/.test(path);
